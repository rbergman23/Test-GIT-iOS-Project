...
-(NSArray *)tiles;
{
    ...
    tile1.story = @"Captain, we need a fearless leader such as yourself to undertake a voyage. You must stop the evil pirate Boss. Woudl you like a blunted sword to get started?";
